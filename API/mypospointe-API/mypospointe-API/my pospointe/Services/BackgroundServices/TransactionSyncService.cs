...
namespace my_pospointe_api.Services.BackgroundServices
{
    public class TransactionSyncService : BackgroundService
    {
        ...
        public TransactionSyncService(ILogger<TransactionSyncService> logger, IServiceProvider serviceProvider, SharedStateService sharedStateService, ITransactionUploadService transactionUploadService)
        {
            _logger = logger;
